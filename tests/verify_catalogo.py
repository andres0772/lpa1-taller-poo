#!/usr/bin/env python3
"""
Verification script for the Catalogo class
"""
...
def verify_catalogo():
    print("Verifying Catalogo class...")
    ...
    cama = Cama("Test Bed", "wood", "white", 300.0, 1.5, 2.0, "individual", True, True)
